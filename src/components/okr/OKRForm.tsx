...
export function OKRForm({
  ...
  const goToStep1 = () => {
    setStep(1);
    // Reset AI state so it re-triggers on next step 2 entry
        ...
        <form onSubmit={handleSubmit}>
          ...
          {step === 2 && (
            <div className="p-6 space-y-5">
              ...
              {/* Edit mode: show title + category + quarter inline */}
              {isEditing && (
                <>
                  <div>
                    <label htmlFor="okr-title-edit" className="text-[11px] font-semibold text-muted uppercase tracking-wider block mb-1.5">
                      Titel *
                    </label>
                    <input
                      id="okr-title-edit"
                  ...
                  <div>
                    <label htmlFor="okr-why-edit" className="text-[11px] font-semibold text-muted uppercase tracking-wider block mb-1.5">
                      Warum ist das wichtig?
                    </label>
                    <textarea
                      id="okr-why-edit"
                    ...
                    <button
                      ...
                      onClick={() => {
                        suggestMutation.mutate(
                          ...
                          {
                            onSuccess: (data) => {
                              // In edit mode, directly add suggestions as manual KRs
